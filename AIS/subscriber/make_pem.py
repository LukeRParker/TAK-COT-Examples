#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# This code has been modified from the original version that can be found at https://github.com/snstac/pytak
# which is subject to the following original licence.
#
